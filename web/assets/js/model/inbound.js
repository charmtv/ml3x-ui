...
Inbound.VmessSettings.VMESS = class extends Inbound.ClientBase {
    constructor(
        ...
        email, limitIp, deviceLimit, totalGB, expiryTime, enable, tgId, subId, comment, reset, created_at, updated_at,
    ) {
        super(email, limitIp, deviceLimit, totalGB, expiryTime, enable, tgId, subId, comment, reset, created_at, updated_at);
        this.id = id;
        this.security = security;
    }
